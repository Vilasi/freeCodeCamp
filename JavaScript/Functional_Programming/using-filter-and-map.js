...
//This function is the callback function passed to filter
let filtering = x => x["imdbRating"] >= 8;

// Applies the filter (as per the callback) to watchList, and then returns a new array consisting of the titles and ratings
// of the filtered object.
let filteredList = watchList.filter(filtering).map(x => {
